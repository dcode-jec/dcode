...
const EventsPage = () => {
  ...
  const mainEvent = filteredEvents.find(ev => ev.isMain) || filteredEvents[0];
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-4 text-sm text-tertiary">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span>{mainEvent.location || 'Main Campus Hub'}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {regularEvents.map((ev, idx) => (
                    ...
                    >
                      ...
                      <p className="font-body-sm text-sm text-on-surface-variant mb-6 line-clamp-2">{ev.description}</p>
                    </motion.article>
                  ))}
                </div>
              </motion.div>
